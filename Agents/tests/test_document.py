...
class TestDocumentPathToMarkdown:
    ...
    def test_document_path_to_markdown_with_docx(self):
        """Test converting a DOCX file from path to markdown."""
    ...
    def test_document_path_to_markdown_with_pdf(self):
        """Test converting a PDF file from path to markdown."""
    ...
    def test_document_path_to_markdown_relative_path(self):
        """Test that relative paths are handled correctly."""
        # Get relative path from current working directory
        rel_path = os.path.relpath(self.DOCX_FIXTURE)
